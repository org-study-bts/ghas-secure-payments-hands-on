...
2. Execute `mvn test`, depois `mvn spring-boot:run` e consulte `/health`.
3. Crie uma branch de trabalho, faça um commit inicial e observe o workflow **Phase 1 - baseline**.
...
Codespaces, Actions, Secret Scanning e Push Protection dependem de plano, política e permissões. Se algum recurso não estiver disponível, registre a limitação e continue com os testes locais.
