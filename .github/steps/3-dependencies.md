...
Em um pull request, observe o workflow `Phase 3 - dependency review` e o `dependency-review-action@v5.0.0` (tag verificada no upstream). Ele usa permissões de leitura e sinaliza severidade alta como exemplo. Revise o pacote, versão instalada, versão corrigida, impacto da atualização e testes antes de fazer merge.
